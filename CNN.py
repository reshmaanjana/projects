...
def predict_spam_cnn(input_text):
    ...
    loaded_model = tf.keras.models.load_model('spam_detection_cnn_model.h5')
...
# Example usage
input_text = "Claim your prize now! You've won $1000000."
prediction = predict_spam_cnn(input_text)
